...
<head>
	...
	<script class="jeux" type="text/javascript" src="Jeux2D/main.js"></script>
    <?php
...
<body>
    <form method="post" action="">
        ...
        <a href="Parametre.php"><input class="btn" type="button" name="parametre" value="Mes Paramètre"/></a>
        <a href="Jeux2.php"><input class="btnJeux" type="button" name="btnJeux" value="Autre Jeux"/></a>
        ...
        <a href="Jeux.php"><input class="btnRejouer" type="button" name="rejouer" value="Rejouer"/> </a>
    </form>
    <?php
